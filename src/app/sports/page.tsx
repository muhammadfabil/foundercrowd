    ...
    <>
      ...
      <main className="bg-[#f2f5ff] text-[#2B2B2B] font-figtree">
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="h-20 md:h-34 overflow-hidden relative mb-2">
                <div className="text-center">
                  ...
                  <div className="relative overflow-hidden h-12 md:h-16">
                    <p
                      className="text-2xl md:text-3xl font-medium text-[#5271ff] absolute transition-all duration-500 w-full text-center"
                      style={{
              ...
              <p className="text-lg md:text-xl text-white/80 mb-6 max-w-2xl mx-auto">
                Space Funding Sports is where clubs, teams, and sports innovators turn their passion
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="relative bg-[#2B2B2B] rounded-xl p-8 text-white overflow-hidden h-80">
                <div className="absolute bottom-6 right-6">
                  <div className="w-12 h-12 bg-[#5271ff] rounded-lg flex items-center justify-center">
        ...
        <section className="py-12 bg-white">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-6xl font-bold mb-6 text-[#5271ff]">Ready to take your club or sports startup to the next level?</h2>
              <p className="text-lg text-[#5271ff]/80 mb-8">
