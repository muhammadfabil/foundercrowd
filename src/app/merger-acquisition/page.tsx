  ...
  return (
    <>
      ...
      <main className="bg-white text-[#2B2B2B] font-figtree">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="mb-12">
                <div className="mx-auto max-w-4xl relative">
                  <div className="aspect-[16/9] overflow-hidden rounded-lg md:rounded-xl shadow-xl border border-gray-300">
                    <iframe
              ...
              <p className="text-lg leading-relaxed mb-8 text-white/70">
                ...
                At Space Funding, we bring our expertise, experience, and technology to help founders
                navigate the full M&A journey — from identifying the right acquirer to closing the deal on founder-first terms.
              </p>
              <div className="w-16 h-1 bg-[#5271ff] mx-auto rounded-full"></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
              {/* Feature 1 */}
              <div className="bg-gray-50 p-6 rounded-xl shadow-md transform transition-all duration-500 hover:shadow-lg">
                <div className="w-12 h-12 bg-[#5271ff] rounded-lg mb-6 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-[#2B2B2B]">
        ...
        <section className="py-16 md:py-24 bg-gray-50 text-[#2B2B2B]">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              <div className="flex items-start gap-6 bg-gray-50 backdrop-blur-sm p-6 rounded-xl border border-gray-200 transform transition-all duration-500 hover:bg-gray-100">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-[#5271ff] rounded-full flex items-center justify-center text-[#2B2B2B] font-bold text-lg">1</div>
                </div>
                <div>
              ...
              <div className="flex items-start gap-6 bg-gray-50 backdrop-blur-sm p-6 rounded-xl border border-gray-200 transform transition-all duration-500 hover:bg-gray-100">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-[#5271ff] rounded-full flex items-center justify-center text-[#2B2B2B] font-bold text-lg">2</div>
                </div>
                <div>
                  <p className="text-xl font-medium">
              ...
              <div className="flex items-start gap-6 bg-gray-50 backdrop-blur-sm p-6 rounded-xl border border-gray-200 transform transition-all duration-500 hover:bg-gray-100">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-[#5271ff] rounded-full flex items-center justify-center text-[#2B2B2B] font-bold text-lg">3</div>
                </div>
                <div>
                  <p className="text-xl font-medium">
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {/* Mission 1 */}
              <div className="bg-gray-100 p-8 rounded-xl border border-gray-200 transform transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
        ...
        <section className="py-20 bg-gray-50">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-[#5271ff] mb-8">
