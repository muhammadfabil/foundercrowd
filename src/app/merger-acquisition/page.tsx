            ...
            <div className="max-w-3xl mx-auto space-y-8">
              <div className="flex items-start gap-6 bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 transform transition-all duration-500 hover:bg-white/10">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-[#5271ff] rounded-full flex items-center justify-center text-white font-bold text-lg">1</div>
                </div>
                <div>
              ...
              <div className="flex items-start gap-6 bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 transform transition-all duration-500 hover:bg-white/10">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-[#5271ff] rounded-full flex items-center justify-center text-white font-bold text-lg">2</div>
                </div>
                <div>
                  <p className="text-xl font-medium">
              ...
              <div className="flex items-start gap-6 bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 transform transition-all duration-500 hover:bg-white/10">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-[#5271ff] rounded-full flex items-center justify-center text-white font-bold text-lg">3</div>
                </div>
                <div>
                  <p className="text-xl font-medium">
